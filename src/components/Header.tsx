    ...
    <header className="bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral-700">
      <div className="px-4 py-1.5">
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center w-6 h-6 bg-neutral-900 dark:bg-neutral-100 rounded-lg">
            <FileCode2 size={14} className="text-white dark:text-neutral-900" strokeWidth={2.5} />
          </div>
